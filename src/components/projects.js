...
const Projects = () => {
  ...
  const projectsData = {
    fairJobPortal: {
      ...
      description: "Fair Job is a cutting-edge AI-powered job portal that combines the power of Generative AI and LLMs to simplify and improve the hiring process for both job seekers and employers.",
      features: [
    ...
    smartQR: {
      ...
      image: "https://images.unsplash.com/photo-1533749047139-189de3cf06d3?q=80&w=2069&auto=format&fit=crop",
      description: "Revolutionize your dining experience with our AI-powered, contactless ordering system. SmartQR simplifies restaurant interaction through intelligent chatbot-driven ordering.",
      features: [
    ...
    supermarketAnalytics: {
      ...
      description: "Optimize supermarket sales and inventory management through automated reporting and intelligent restocking suggestions powered by advanced AI models.",
      features: [
    ...
    liquorDelivery: {
      ...
      image: "https://images.unsplash.com/photo-1516997121675-4c2d1684aa3e?q=80&w=2069&auto=format&fit=crop",
      description: "A secure, mobile-first platform for ordering and delivering liquor products with age verification and real-time tracking capabilities. This solution streamlines the delivery process while ensuring compliance with local regulations.",
      features: [
    ...
    worksuite: {
      ...
      description: "A comprehensive employee management solution that streamlines HR processes, attendance tracking, and performance management. The system provides powerful analytics and reporting tools for better workforce management.",
      features: [
    ...
    smsGateway: {
      ...
      description: "A robust SMS communication platform that enables businesses to send bulk messages, automated notifications, and two-factor authentication codes. The system handles high volumes of messages with real-time delivery tracking.",
      features: [
        "Bulk SMS sending",
        "Delivery tracking",
        "API integration",
    ...
    carRental: {
      ...
      description: "An online platform designed to facilitate seamless car rentals, allowing customers to search, book, and manage vehicle rentals while providing administrators with comprehensive management tools.",
      features: [
    ...
    tableTrack: {
      ...
      description: "A comprehensive solution designed for restaurants and retail stores, integrating seamlessly with POS systems for efficient table management and order tracking.",
      features: [
        "Real-time order tracking",
        "Table management",
    ...
    warehouseSystem: {
      ...
      description: "A robust solution designed to optimize warehouse operations, including inventory management, order processing, and shipment tracking with real-time updates and automation.",
      features: [
    ...
    crudFirebase: {
      ...
      description: "A powerful system designed for managing data through Firebase, offering a web-based interface that allows users to perform Create, Read, Update, and Delete operations on data stored in Firestore.",
      features: [
    ...
    nexTask: {
      ...
      description: "A comprehensive solution designed to streamline project planning, task management, and team collaboration. It offers features such as task assignment, progress tracking, and real-time notifications.",
      features: [
    ...
    bookingHub: {
      ...
      description: "A comprehensive platform designed to simplify event planning and management. It enables organizers to create and manage events, handle online ticket bookings, and securely process payments.",
      features: [
    ...
    blackPOS: {
      ...
      description: "A comprehensive solution for businesses to efficiently manage product inventories, sales transactions, and reporting. The system streamlines store operations and enhances customer experience through its intuitive interface.",
      features: [
        "Real-time inventory tracking",
    ...
    parcelBox: {
      ...
      image: "https://images.unsplash.com/photo-1553413077-190dd305871c?q=80&w=2070&auto=format&fit=crop",
      description: "A comprehensive platform designed to help businesses efficiently manage their inventory, sales, and purchase records with real-time tracking and automated updates.",
      features: [
        "Real-time inventory tracking",
    ...
    niftyEws: {
      ...
      description: "A comprehensive platform designed to streamline the entire loan lifecycle, from application and approval to repayment and tracking with automated notifications.",
      features: [
    ...
    emailBuilder: {
      ...
      image: "https://images.unsplash.com/photo-1526649661456-89c7ed4d00b8?q=80&w=2070&auto=format&fit=crop",
      description: "An intuitive, web-based application designed to help users create, customize, and export responsive email templates without any coding skills.",
      features: [
    ...
    dentalCRM: {
      ...
      description: "A comprehensive solution designed to manage patient data, appointments, prescriptions, and invoices for dental clinics.",
      features: [
        "Patient management",
    ...
    agriPortal: {
      ...
      description: "A web-based platform designed to support farmers in optimizing crop yield and resource management using machine learning algorithms.",
      features: [
    ...
    studentPerformance: {
      ...
      description: "A machine learning-powered system that predicts student academic performance based on historical data, providing valuable insights for educational institutions.",
      features: [
    ...
    timetable: {
      ...
      description: "A powerful platform designed to help educational institutions efficiently manage schedules for classes, meetings, and events with automatic conflict detection.",
      features: [
    ...
    quiz: {
      ...
      description: "An interactive online learning platform designed to enhance knowledge retention and mastery through customizable quizzes with real-time feedback.",
      features: [
        "Quiz creation tools",
        "Progress tracking",
        "Real-time feedback",
    ...
    fastnFitness: {
      ...
      description: "An innovative fitness and wellness platform designed to help individuals efficiently achieve their health and fitness goals, even with a busy schedule.",
      features: [
    ...
    farmerCallCenter: {
      ...
      image: "https://images.unsplash.com/photo-1523741543316-beb7fc7023d8?q=80&w=2074&auto=format&fit=crop",
      description: "An innovative helpline platform designed to connect farmers with agricultural experts for timely advice and solutions through AI-driven responses and expert consultations.",
      features: [
        "24/7 Support system",
    ...
    cropRecommendation: {
      ...
      description: "A web-based platform designed to assist farmers in making informed decisions about crop cultivation based on real-time environmental data.",
      features: [
    ...
    torchIO: {
      ...
      description: "An open-source Python library designed to simplify the preprocessing and analysis of 3D medical images for deep learning applications.",
      features: [
    ...
    plantex: {
      ...
      description: "An e-commerce platform designed to provide a seamless shopping experience for plant enthusiasts, gardeners, and farmers.",
      features: [
        "Seller dashboard",
        "Inventory management",
        "Secure payments",
    ...
    farmKart: {
      ...
      description: "An innovative e-commerce platform designed to connect farmers directly with consumers, offering fresh produce and agricultural products without intermediaries.",
      features: [
        ...
        <div className="projects-container">
          <div className="projects-content">
            ...
            <p className="mb-4" style={{ color: "#f1f1f1" }}>
              We are working on exciting projects that we can't wait to share with you.
      ...
      <div className="lvc-difference-section">
        ...
        >
          <SwiperSlide>
            ...
            >
              ...
              <div className="card-content">
                ...
                <p>AI-powered job portal with intelligent matching and assessment</p>
              </div>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div 
              className="difference-card"
              onClick={() => setSelectedProject(projectsData.supermarketAnalytics)}
            >
              <div className="card-image">
                <img 
      ...
      <div className="lvc-difference-section">
        ...
        >
          ...
          <SwiperSlide>
            <div 
              className="difference-card"
              onClick={() => setSelectedProject(projectsData.studentPerformance)}
            >
              <div className="card-image">
                <img 
          ...
          <SwiperSlide>
            <div 
              className="difference-card"
              onClick={() => setSelectedProject(projectsData.cropRecommendation)}
            >
              <div className="card-image">
                <img 
