        ...
        <Carousel className='gradient-background-color bg-black'>
            <Carousel.Item className='spotlight-carousel-scroll' style={{ marginBottom: '0px' }}>
                ...
                <Carousel.Caption className='spotlight-carousel-items-container'>
                    <h2 style={{ color: 'white', fontWeight: 'bolder', fontSize: 'clamp(10px, 3vmax, 80px)' }}>LVC Spotlight Media – PR, Branding & Digital Growth</h2>
                    <p style={{ color: 'white', paddingTop: '5.5vw', textAlign: 'center', fontSize: 'clamp(10px, 2vmax, 80px)', fontWeight: 'normal' }}>
                ...
                <Carousel.Caption className='spotlight-carousel-items-container'>
                    ...
                    <div className='spotlight-carousel-services'>
                        ...
                        <div className='spotlight-slide2-cards pb-1'>
                            <ul className='direction-right' style={{ paddingBottom: '' }}>
                                <h2
                                    style={{
                                        textAlign: 'start',
                                        fontWeight: 'bold',
            ...
            <Carousel.Item className='spotlight-carousel-scroll' style={{ overflow: 'auto' }}>
                ...
                <Carousel.Caption className='spotlight-carousel-items-container'>
                    <h2 style={{ color: 'white', fontWeight: 'bolder', fontSize: 'clamp(10px, 3vmax, 80px)' }}>Why Choose LVC Spotlight Media?</h2>
                    <div className='spotlight-slide2-cards'>
                        <ul className='ul-list-padding-carousel' style={{ paddingBottom: '', marginTop: '' }}>
                            <li style={{ fontSize: 'clamp(1rem, 1.5vmax, 3rem)' }} className='spotlight-slide2-bulletpoints'>
            ...
            <Carousel.Item className='spotlight-carousel-scroll' style={{ overflow: 'auto' }}>
                ...
                <Carousel.Caption className='spotlight-carousel-items-container'>
                    <h2 style={{ color: 'white', fontWeight: 'bolder', fontSize: 'clamp(10px, 3vmax, 80px)', textAlign: 'center' }}>Competitor Comparison Block</h2>
                    ...
                    <table className='spotlight-slide2-grid'>
                        ...
                        <tbody>
                            <tr>
                                <th className='spotlight-grid-row' scope='row'><b style={{color:'black'}}>PR & Media Placements</b></th>
                            ...
                            <tr>
                                <th className='spotlight-grid-row' scope='row'><b style={{color:'black'}}>Founder Branding</b></th>
                            ...
                            <tr>
                                <th className='spotlight-grid-row' scope='row'><b style={{color:'black'}}>Startup, SaaS Focus</b></th>
                            ...
                            <tr>
                                <th className='spotlight-grid-row' scope='row'><b style={{color:'black'}}>Digital Marketing</b></th>
                            ...
                            <tr>
                                <th className='spotlight-grid-row' scope='row'><b style={{color:'black'}}>Speed of Results</b></th>
                            ...
                            <tr>
                                <th className='spotlight-grid-row' scope='row'><b style={{color:'black'}}>Pricing</b></th>
